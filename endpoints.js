  ...
  '/api': {
    ...
    '/articles': {
      ...
      'GET /api/articles/:article_id': {
        description: 'This enpoint returns article that matches given article ID',
      },
      ...
      'DELETE /api/articles/:article_id': {
        description: 'This endpoint allows the user to delete an article, referencing article ID',
      },
    },
    '/comments': {
      ...
      'DELETE /api/comments/:comment_id': {
        description: 'This endpoint allows the user to delete a comment, referencing comment_id',
      },
    },
    '/users': {
      'GET /api/users': {
